    ...
    <div id="wrapper">
       ...
       <!-- Page Content -->
        <div id="page-wrapper">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Shot Item</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-md-7">
                    <div class="well">
                        <form class="form-horizontal" method="POST" action="../process/addshot_process.php" id="shot">
                <fieldset>
                  ...
                  <div class="controls">
                   <select class="form-control" id="itemname" name="itemname">
                       ...
                       <?php 
                                 ...
                                 $query = "SELECT * FROM stock_drink WHERE category_id = 2";
                                $result = $database->execute($query);
                                        while ($grp = mysql_fetch_assoc($result)) {
                                        echo "<option value= $grp[drink_id]>".$grp['name']."</option>";
                                        }
                ...
                <div class="control-group">
                  <label class="control-label" for="quantity">Number of shots per drink</label>
                  <div class="controls">
                    <input id="quantity" name="shots" type="text" placeholder="" class="form-control">
                    
                  </div>
                </div>

                <div class="control-group">
                  <label class="control-label" for="minimum">Minimum</label>
                  <div class="controls">
                    <input id="minimum" name="minimum" type="text" placeholder="" class="form-control">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <button id="additem" name="additem" class="btn btn-primary">Add Drink</button>
                  </div>
                </div>
