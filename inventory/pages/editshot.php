    ...
    <div id="wrapper">
       ...
       <!-- Page Content -->
        <div id="page-wrapper">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Shot Item</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-md-7">
                    <div class="well">
        <form class="form-horizontal" action="../process/editshot_process.php" method="POST" id="shotUpdate">
                <fieldset>
                  ...
                  <div class="controls">
                   <select class="form-control" id="itemname" name="itemname">
                        ...
                        <?php 
                                 ...
                                 $query = "SELECT stock_drink.drink_id,stock_drink.name,stock.stock_id FROM stock_drink,stock WHERE stock_drink.category_id = 2 AND stock_drink.drink_id = stock.drink_id";
