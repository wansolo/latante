    ...
    <div id="wrapper">
       ...
       <!-- Page Content -->
        <div id="page-wrapper">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Bottle Item</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-md-7">
                    <div class="well">
        <form class="form-horizontal" action="../process/addbottle_process.php" method="POST" id="drink">
                <fieldset>
                  ...
                  <div class="controls">
                   <select class="form-control" id="itemname" name="itemname">
                        ...
                        <?php 
                                 ...
                                 $query = "SELECT * FROM stock_drink WHERE category_id = 1";
                ...
                <div class="control-group">
                  <label class="control-label" for="minimum">Minimum Required Quantity</label>
                  <div class="controls">
