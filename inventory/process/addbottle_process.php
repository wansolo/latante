<?php 
	...
	$count  = $fetch['kaunt'];
			...
			if($count > 0){
    			...
    			$qeury_stmt1 = "INSERT INTO stock(current_quantity, threshold, drink_id,old_drink_id,grand_quantity) 
    				VALUES ($quantity,$minimum,$itemname,$old,$quantity)";
				...
				echo "<meta http-equiv=Refresh content=3;url=addbottle.php>";
					}
