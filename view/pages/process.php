...
if ($_POST) {
	...
	foreach ($_POST as $key => $value) {
		...
		/*drink filteration will happen below
		 ....................................
		*/
    				...
    				$newFood = mysql_fetch_array($result10);
                 	...
                 	//$dummy = "";
      				...
      				for ($k=0; $k < count($drinks_array); $k++) { 
      						if ($food_id[$i] == $drinks_array[$k]) {

      							$val_num = $food_id[$i];
      							$stock_update = "UPDATE stock SET grand_quantity = grand_quantity - $quantity[$i]
      											 WHERE old_drink_id= $val_num";
    							$stock_result = mysql_query($stock_update,$con);
      						}
      				}
      				*/
