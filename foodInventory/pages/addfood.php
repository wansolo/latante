    ...
    <div id="wrapper">
       ...
       <!-- Page Content -->
        <div id="page-wrapper">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Food Item To Stock</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-md-7">
                    <div class="well">
                      <form role="form" action="../process/addfood_process.php" method="POST" id="Addfood">
                        ...
                        <select class="form-control" name="itemname">
                            <option value="">Select food Name</option>
                             <?php 
                                 ...
                                 $query = "SELECT * FROM InventoryFood";
                                $result = $database->execute($query);
                                        while ($grp = mysql_fetch_assoc($result)) {
                                        echo "<option value= $grp[food_id]>".$grp['food_name']."</option>";
                                        }
                      ...
                      <button type="submit" class="btn btn-primary" >Add food To Stock</button>
                </form>
                    </div>
