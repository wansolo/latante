    ...
    <div id="wrapper">
       ...
       <!-- Page Content -->
        <div id="page-wrapper">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Food Item To Food List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-md-7">
                    <div class="well">
                      <form role="form" action="../process/addlist_process.php" method="POST" id="Addlist">
                        ...
                        <select class="form-control" name="category">
                            <option value="">Select food category</option>
                             <?php 
                                 ...
                                 $query = "SELECT * FROM InventoryFoodCategory";
                                $result = $database->execute($query);
                                        while ($grp = mysql_fetch_assoc($result)) {
                                        echo "<option value= $grp[foodCat_id]>".$grp['category_name']."</option>";
                                        }
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fooditem">
                      </div>
                      
                       <div class="form-group">
                        <label for="exampleInputPassword1">Unit Of Measure</label>
