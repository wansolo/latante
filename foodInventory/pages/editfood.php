    ...
    <div id="wrapper">
       ...
       <!-- Page Content -->
        <div id="page-wrapper">
             <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Food Item In Stock</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-md-7">
                    <div class="well">
                    <form role="form" action="../process/updatefood_process.php" method="POST" id="updatefood">
                             ...
                             <div class="table table-responsive">
                              ...
                              <table class="table table-stripped table-bordered">
                                  <thead>
                                      ...
                                      <th class="info">Unit Of Measure</th>
                                  </thead>
                                  <tbody>
                                      <?php 
