<?php 
	...
	$count  = $fetch['kaunt'];
			...
			if($count > 0){
				...
				$log = "INSERT INTO food_log_entry(user_id,stock_id,quantity,operation_type) VALUES ($user,$stock_id,$quantity,'Out Flow')";
				$database->execute($log);

				echo "<h3 class=\"alert alert-success\">Food Taken Successfully</h3>";
